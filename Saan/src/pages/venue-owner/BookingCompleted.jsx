...
import { FaCheckCircle, FaCalendar, FaUsers } from "react-icons/fa";
...
function BookingCompleted() {
  ...
  // Fetch venue bookings with COMPLETED status only
  useEffect(() => {
      ...
      try {
        ...
        if (regResponse.success && regResponse.registration && regResponse.exists) {
          ...
          if (bookingsResponse.success) {
            const fetchedBookings = (bookingsResponse.bookings || []).filter(b => b.status === 'completed');
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-800">Completed Events</h1>
        <p className="text-gray-500 mt-1">View history of completed bookings and events</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">No Completed Events</h2>
        ...
        <div className="space-y-4">
          {bookings.map(booking => (
            <div key={booking._id} className="bg-blue-50 border-l-4 border-blue-200 rounded-lg p-6 shadow-sm">
              {/* Header with Status */}
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 font-medium uppercase">Completed</p>
                  </div>
                </div>
              </div>
