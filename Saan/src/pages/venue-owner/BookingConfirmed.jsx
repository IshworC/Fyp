...
import { FaCheckCircle, FaTimesCircle, FaCalendar, FaUsers, FaClock } from "react-icons/fa";
...
function BookingConfirmed() {
  ...
  // Fetch venue bookings with CONFIRMED status only
  useEffect(() => {
      ...
      try {
        ...
        if (regResponse.success && regResponse.registration && regResponse.exists) {
          ...
          if (bookingsResponse.success) {
            const fetchedBookings = (bookingsResponse.bookings || []).filter(b => b.status === 'confirmed');
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">View your confirmed and upcoming bookings</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">No Confirmed Bookings</h2>
        ...
        <div className="space-y-4">
          {bookings.map(booking => (
            <div key={booking._id} className="bg-green-50 border-l-4 border-green-200 rounded-lg p-6 shadow-sm">
              {/* Header with Status */}
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 font-medium uppercase">Confirmed</p>
                  </div>
                </div>
              </div>
